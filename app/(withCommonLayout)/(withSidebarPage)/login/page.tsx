...
const SignInPage = () => {
  return (
    <div className="pb-12">
      <SidebarPageTitle title="Your Documents - Sign In" />
      <div className="space-y-1">
        <div className="mt-4 space-y-2 w-full">
          <p className="font-bold">
            A unique link will then be sent to your email allowing you to login
          </p>
        </div>
        <p className="text-sm text-pera sm:text-base">
          Please use the email address you used to save your documents.
        </p>
      </div>
